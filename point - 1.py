...
trainFeat = np.load('new_add/labeledF1.npy')
Pindex = np.load('new_add/prototype1.npy')
label = np.load('new_add/Labeled_L1.npy')
...
plt.title('After Stage I', font='Times New Roman', fontsize=18)
# 去掉刻度
plt.xticks([])
plt.yticks([])
plt.savefig('new_add/stage1-2.png', bbox_inches='tight')
# 显示图形
plt.show()