...
trainFeat = np.load('new_add/labeledF4.npy')
Pindex = np.load('new_add/prototype4.npy')
label = np.load('new_add/Labeled_L4.npy')
...
plt.title('After Stage IV', font='Times New Roman', fontsize=18)
# 去掉刻度
plt.xticks([])
plt.yticks([])
plt.savefig('new_add/stage4-2.png', bbox_inches='tight')
# 显示图形
plt.show()